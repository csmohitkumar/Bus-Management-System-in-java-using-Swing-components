...
/**Through this class administrator can update,search and delete the records of passengers and cancel the operation. this class is implimenting the interfae namely Admin method*/
public class AdminPassengerDetails implements ActionListener,InterfaceAdmin
{
	private JFrame frame;
	private JButton btnDelete,btnClear,btnExit,btnUpdate,btnSearch;
	...
	private JTextField txtFName,txtLName,txtUName,txtEmail,txtCNo,txtFaName,txtOccu,txtBG;
	private JComboBox cboDobdate, cboDobmonth,cboDobyear,cboID,cbogender;
	private JTextArea Address;
	private JRadioButton radMale,radFemale;
	private JPanel top,center,bottom;
	private Color color1,color2,color3;
	private Font font;
	private String fname=null,lname=null,father=null,occu=null,bg,em,address,cn,id,gender,dobd,dobm,doby,date,select;
	private int validate,f=0;
	...
	public AdminPassengerDetails()
	{
		frame=new JFrame("Passenger Detail");
		top=new JPanel();
		center=new JPanel();
		bottom=new JPanel();
	...
	public void launchFrame_passenger()
	{
		...
		center.add(cboID);
		cboID.setBounds(240,440,150,20);
		...
		frame.setBounds(400,50,600,660);
	 ...
	 /**get the value from the passenger_details table and insert it to the combobox*/
	...
	/**Search the fields of the passenger with respect to id from the database*/
	 public boolean search(int bbus)
	  {
		  ...
		  try
		  {
		   ...
		   System.out.println("Connection established successfully");
           Statement state = connect.createStatement();
              String sql = "select * from passenger_details where passenger_id="+ id +"";
		      ...
		      if(rs.next())
              {
					...
					txtFaName.setText(rs.getString("father_name"));
					txtOccu.setText(rs.getString("occupation"));
                    txtBG.setText(rs.getString("blood_group"));

					txtEmail.setText(rs.getString("email"));

					String strmale=rs.getString("gender");
					cbogender.setSelectedItem(strmale);

					Address.setText(rs.getString("address"));
                    
					String strddate=rs.getString("dobdate");
					...
					txtCNo.setText(rs.getString("contact_no"));
                    cboID.setSelectedItem(rs.getString("passenger_id"));
		  ...
		  /**Delete record of the passenger from the table*/
		  public void delete(int bbus)
		  {
			  try
			  {
				 Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
		   ...
		   System.out.println("Connection established successfully");
           Statement state = connect.createStatement();
				 String sql="delete from passenger_details where passenger_id="+ id +"";
				 state.execute(sql);
				 cboID.removeItem(id);
		  ...
		  public void update(int iid)
		  {
		   ...
		   System.out.println("Connection established successfully");
           Statement state = connect.createStatement();
				String sql0 = "update passenger_details set fname='"+ fname+"' where passenger_id="+ id +"";
				String sql1 = "update passenger_details set lname='"+ lname+"' where passenger_id="+ id +"";
				String sql2 = "update passenger_details set father_name='"+ father+"' where passenger_id="+ id +"";
				String sql3 = "update passenger_details set occupation='"+occu+"' where passenger_id="+ id +"";
				String sql4 = "update passenger_details set blood_group='"+ bg+"' where passenger_id="+ id +"";
				String sql5 = "update passenger_details set email='"+ em+"' where passenger_id="+ id +"";
				String sql6 = "update passenger_details set gender='"+gender+"' where passenger_id="+ id +"";
				String sql7 = "update passenger_details set address='"+ address+"' where passenger_id="+ id +"";
				String sql8 = "update passenger_details set contact_no='"+cn+"' where passenger_id="+ id +"";
				String sql9 = "update passenger_details set dobdate='"+date+"' where passenger_id="+ id +"";
